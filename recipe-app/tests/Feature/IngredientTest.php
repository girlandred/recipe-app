...
class IngredientTest extends TestCase
{
    ...
    public function testCanAccessIngredientCreateForm()
    {
        ...
        $response = $this->actingAs($this->user)->get(route('admin.ingredients.create', $ingredient->id));
    ...
    public function testUnauthorisedAccessToIngredientCreateFormWhenNotLoggedIn()
    {
        ...
        $response = $this->get(route('admin.ingredients.create', $ingredient->id));
    ...
    public function testCanAccessAnIngredientPage()
    {
        ...
        $response = $this->actingAs($this->user)->get(route('admin.ingredients.show', $ingredient->id));
    ...
    public function testDeniedAccessToShowingIngredientWithoutPermission()
    {
        ...
        $response = $this->get(route('admin.ingredients.show', $ingredient->id));
    ...
    public function testCanAccessTheIngredientEditForm()
    {
        ...
        $response = $this->actingAs($this->user)->get(route('admin.ingredients.edit', $ingredient->id));
    ...
    public function testDeniedAccessToIngredientEditFormWithoutPermission()
    {
        ...
        $response = $this->get(route('admin.ingredients.edit', $ingredient->id));
    ...
    public function testDeniedAccessToEditTheIngredientWhenNotTheOwner()
    {
        ...
        $response = $this->actingAs($user)->get(route('admin.ingredients.edit', $ingredient->id));
    ...
    public function testAnIngredientCanBeUpdated()
    {
        ...
        $response = $this->actingAs($this->user)->patch(route('admin.ingredients.update', $ingredient->id), $data);
    ...
    public function testDeniedAccessToIngredientCanBeUpdatedWithoutPermission()
    {
        ...
        $response = $this->actingAs($user)->patch(route('admin.ingredients.update', $ingredient->id), $data);
    ...
    public function testAnIngredientCanBeDeleted()
    {
        ...
        $this->actingAs($this->user)->delete(route('admin.ingredients.destroy', $ingredient->id));
    ...
    public function testDeniedAccessToIngredientCanBeDeletedWithoutPermission()
    {
        ...
        $response = $this->actingAs($user)->delete(route('admin.ingredients.destroy', $ingredient->id));
